<?php
# wat is de namespace voor PHP instructie?
# classname: Upload 
# Scope: Verot\Upload
namespace Verot\Upload;

# stelt de error weergave voor (zoveel mogelijk aan) met display_errors = Off kan het uit
...
// set variables
$dir_dest = (isset($_GET['dir']) ? $_GET['dir'] : 'tmp'); # waar komt het bestand in terecht. (welke map)
$dir_pics = (isset($_GET['pics']) ? $_GET['pics'] : $dir_dest); # wordt 'tmp' tenzij anders aangegeven

$log = ''; # iets met een log(bestand)?
